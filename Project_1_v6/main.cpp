...
//Declare and initialize variables
    ...
    bool  game=true, loopFn2=true;                      //loop variables
    ...
    int   mines,numMine;                  //how many mines are on field
...
switch(diff){
    case 'A':mines=8;break;
    case 'B':mines=6;break;
    case 'C':mines=4;break;
    default:{cout<<"You have input an incorrect value. Try again."<<endl;
    loopFn2=false;
}}}while(loopFn2==false);
